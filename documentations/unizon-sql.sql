...
CREATE TABLE UNI_USER_DATA
  (
    USER_ID            INT NOT NULL ,
    PHONE_NUMBER_ID    INT NOT NULL ,
    DEFAULT_ADDRESS_ID INT NOT NULL
  ) ;
CREATE INDEX USER_ADDRESS_FK ON UNI_USER_DATA
  ( DEFAULT_ADDRESS_ID ASC
  ) ;
ALTER TABLE UNI_USER_DATA ADD CONSTRAINT USER_PK PRIMARY KEY ( USER_ID ) ;
...
ALTER TABLE ADDRESSES_OF_USER ADD CONSTRAINT ADDRESSES_OF_USER_USER_FK FOREIGN KEY ( USER_ID ) REFERENCES UNI_USER_DATA ( USER_ID ) ;
...
ALTER TABLE UNI_ORDER ADD CONSTRAINT ORDER_USER_FK FOREIGN KEY ( USER_ID ) REFERENCES UNI_USER_DATA ( USER_ID ) ;
...
ALTER TABLE UNI_USER_DATA ADD CONSTRAINT UNI_USER_DATA_UNI_USER_FK FOREIGN KEY ( USER_ID ) REFERENCES UNI_USER ( USER_ID ) ;

ALTER TABLE UNI_USER_DATA ADD CONSTRAINT USER_ADDRESS_FK FOREIGN KEY ( DEFAULT_ADDRESS_ID ) REFERENCES ADDRESS ( ADDRESS_ID ) ;

ALTER TABLE UNI_USER_DATA ADD CONSTRAINT USER_PHONE_NUMBER_FK FOREIGN KEY ( PHONE_NUMBER_ID ) REFERENCES PHONE_NUMBER ( PHONE_NUMBER_ID ) ;
