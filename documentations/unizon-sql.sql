...
INSERT INTO UNI_USER(USER_ID, USERNAME, PASSWORD, E_MAIL, NAME, REGISTRATION_DATE, STATUS_ID)
    VALUES(-4,'test3','Nh0+SvHXJoJzrFK71qXs693ftunFkoQ60N/qT5AphOI=$k2xO8Xgy7UbUxKdnAf+8ghdViNeHxFm0jgWpapOgbdE=','test3@gmail.com','Test3 User', '2015-03-04', -2);

INSERT INTO UNI_USER(USER_ID, USERNAME, PASSWORD, E_MAIL, NAME, REGISTRATION_DATE, STATUS_ID)
    VALUES(-5,'test4','xxZiRzrq4yeNuS/O/K/JIwQZb8aL9l6AhoJ4anTlFNU=$Wo+3DXAYNs1euay9WtgMG7iCirIXPfZQBqmGiuygJWY=','test4@gmail.com','Test4 User', '2015-03-04', -2);
